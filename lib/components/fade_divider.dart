    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            Colors.black.withOpacity(0.6), // Completely transparent at start
            Colors.black.withOpacity(0.5), // Slight fade-in
            Colors.black.withOpacity(0.3), // More visible in the middle
            Colors.black.withOpacity(0.1), // Fading out again
            Colors.black.withOpacity(0.0), // Completely transparent at end
          ],
